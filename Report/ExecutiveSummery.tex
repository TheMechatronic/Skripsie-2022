...
\newcommand{\SummeryPage}{%
	...
	\begin{Summary}{\DegreeNameLong: \\Executive Summary}
		...
		\begin{SumTable}
			...
			\hline%-------------------------------------------------------------
			\SumCell{What is new in this project?}{\US@NewInProject}
			\hline%-------------------------------------------------------------
			\SumCell{If the project is successful, how will it make a difference?}{\US@ProjectDifference}
			\hline%-------------------------------------------------------------
			\SumCell{What are the risks to the project being a success? Why is it expected to be successful?}{\US@ProjectRisks}
			\hline%-------------------------------------------------------------
