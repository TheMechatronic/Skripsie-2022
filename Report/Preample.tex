...
\usepackage{enumitem}
\usepackage{mfirstuc}
\MFUnocap{and}\MFUnocap{is}\MFUnocap{a}\MFUnocap{an}\MFUnocap{of}\MFUnocap{to}\MFUnocap{can}\MFUnocap{be}\MFUnocap{on}\MFUnocap{the}\MFUnocap{with}\MFUnocap{for}
\usepackage{xcolor}
\usepackage{ragged2e}
\usepackage{booktabs}
...
\newcommand\tablestretch{1.2}		

\newcounter{reqCount}
\setcounter{reqCount}{0}

\makeatletter
\newcommand\newR[1]{\stepcounter{reqCount}\thereqCount\def\@currentlabel{\thereqCount}\label{#1}}
\makeatother
